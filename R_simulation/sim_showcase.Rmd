...
### Discrete: *discr*
Confirmatory and disconfirmatory outcomes have separate learning rates, where LR_conf > LR_disconf. As a standard, we say `LR_conf` is 0.7, `LR_disconf` is 0.3 and `margin` is 2.

#### Close to belief: *approx*
$$LR =
\begin{cases}
...
#### Greater or equal to belief: *geq*
$$LR =
\begin{cases}

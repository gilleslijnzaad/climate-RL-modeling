...
In this R markdown I use code from the following files (click = download): [sim.R](../R_simulation/sim.R), [plot_utils.R](../plot_utils.R), [utils.R](../utils.R).
...
## Inspect results
```{r posterior-plots, fig.height = 4}

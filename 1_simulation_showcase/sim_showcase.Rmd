...
With these settings, the confirmatory learning rate is used around 40% of trials (across all participants). 
...
#### *stat* {.unnumbered}
```{r run-LRN-cont-stat, eval = FALSE}
sim <- new.env()

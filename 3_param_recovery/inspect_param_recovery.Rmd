...
free_params <- c("inv_temp_group", "initQ_dev_group")
...
free_params <- c("LR_group", "inv_temp_group", "initQ_dev_group")
...
## Simulation behavior
![Plot of simulated data for model 2](2_LRN_discr_approx_stat/1_run/sim_plots.png)
...
free_params <- c("LR_disconf_group", "LR_diff_group", "inv_temp_group", "initQ_dev_group")
draws <- readRDS(fit_path) %>%
  rename(setNames(paste0("means[", seq_along(free_params), "]"),
                  free_params))
